...
import type { VideoStyleConfig, VideoStyleDropdownDefinition, VideoStyleOptionDefinition } from '../videoconfig';
...
function getDefaultStylesConfiguration(isBlockPluginLoaded: boolean, isInlinePluginLoaded: boolean): VideoStyleConfig {
...
function getDefaultDropdownDefinitions(pluginCollection: PluginCollection<Editor>): Array<VideoStyleDropdownDefinition> {
...
function normalizeDefinition(definition: string | Partial<VideoStyleOptionDefinition> & { name: string, icon?: string }): VideoStyleOptionDefinition {
...
function isValidOption(option: VideoStyleOptionDefinition, { isBlockPluginLoaded, isInlinePluginLoaded }: { isBlockPluginLoaded: boolean; isInlinePluginLoaded: boolean }): boolean {
...
function extendStyle(source: VideoStyleOptionDefinition, style: Partial<VideoStyleOptionDefinition>): VideoStyleOptionDefinition {
