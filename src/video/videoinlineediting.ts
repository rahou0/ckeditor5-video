    ...
    private _setupConversion():void {
        ...
        conversion.for('editingDowncast')
            .elementToElement({
                ...
                view: (modelElement, { writer }) => videoUtils.toVideoWidget(
                    createVideoViewElement(writer, 'videoInline'), writer
                )
            });
        ...
        conversion.for('upcast')
            .elementToElement({
                ...
                model: (viewVideo, { writer }) => writer.createElement('videoInline', viewVideo.hasAttribute('src') ?{ src: viewVideo.getAttribute('src') }:undefined)
            });
    }
