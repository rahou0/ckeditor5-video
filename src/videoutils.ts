...
export default class VideoUtils extends Plugin {
    ...
    public isVideo(modelElement?: Element | null): modelElement is Element & { name: 'videoInline' | 'videoBlock' } {
    ...
    public insertVideo(attributes: Record<string, unknown> = {}, selectable: Selection | Position | null = null, videoType: ('videoBlock' | 'videoInline' | null) = null): Element | null {
        ...
        return model.change(writer => {
            ...
            model.insertObject(videoElement, selectable, null, {
                ...
                findOptimalPosition: !selectable && videoType != 'videoInline' ? 'auto' : undefined
            });
...
function getInsertVideoParent(selection: Selection | DocumentSelection, model: Model): Element | DocumentFragment {
...
function determineVideoTypeForInsertion(editor: Editor, selectable: Position | Selection | DocumentSelection, videoType: 'videoBlock' | 'videoInline' | null): 'videoBlock' | 'videoInline' {
